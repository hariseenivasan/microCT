...
bool convolve2D(unsigned char* in, unsigned char* out, int dataSizeX, int dataSizeY, 
                float* kernel, int kernelSizeX, int kernelSizeY, unsigned int threshold)
{
    int i, j, m, n;
                ...
                double* kernel, int kernelSizeX, int kernelSizeY)
{
    ...
    int k_size = kernelSizeX * kernelSizeY;
       
    for(int i = 0; i < k_size; i++)
        printf("Kernel values in the conv function %0.2f\n", kernel[i]);
    
    int i_size = dataSizeX * dataSizeY;
